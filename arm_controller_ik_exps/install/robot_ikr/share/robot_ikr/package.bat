...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\robot_ikr\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\robot_ikr\hook\ament_prefix_path.bat"
